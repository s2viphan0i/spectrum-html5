...
Visualizer.prototype = {
    ...
    _drawSpectrum: function(analyser) {
        ...
        gradient.addColorStop(1, '#61bfd4');
        gradient.addColorStop(0, '#61bfd4');
        
        gradient2.addColorStop(1, '#0396FF');
        gradient2.addColorStop(0, '#ABDCFF');
        var drawMeter = function() {
            ...
            for (var i = 0; i < meterNum; i++) {
                ...
                if (value < capYPositionArray[i]) {
                    ctx.fillRect(i * 17, cheight - (--capYPositionArray[i]), meterWidth, capHeight);
                     ctx1.fillRect(i * 17, cheight - (--capYPositionArray[i]), meterWidth, capHeight);
                } else {
                    ctx.fillRect(i * 17, cheight - value, meterWidth, capHeight);
                    ctx1.fillRect(i * 17, cheight - value, meterWidth, capHeight);
                    capYPositionArray[i] = value;
                };
                ctx.fillStyle = gradient; //set the filllStyle to gradient for a better look
                ctx.fillRect(i * 17 /*meterWidth+gap*/ , cheight - value + capHeight, meterWidth, cheight); //the meter
                ctx1.fillRect(i * 17 /*meterWidth+gap*/ , cheight - value + capHeight, meterWidth, cheight); //the meter
            }
